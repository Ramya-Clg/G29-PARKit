...
describe('Validation Schemas', () => {
  ...
  describe('SignupSchema', () => {
    ...
    test('should throw error if name is too short', () => {
      ...
      expect(() => SignupSchema.parse(invalidData)).toThrowError('Name must be at least 2 characters long');
    });
    ...
    test('should throw error if password and confirmPassword do not match', () => {
      ...
      expect(() => SignupSchema.parse(invalidData)).toThrowError("Passwords don't match");
    });
  });
  ...
  describe('ReservationSchema', () => {
    ...
    test('should throw error if vehicle number plate is too short', () => {
      ...
      expect(() => ReservationSchema.parse(invalidData)).toThrowError('Number plate is required');
    });
    ...
    test('should throw error if vehicle number plate has invalid characters', () => {
      ...
      expect(() => ReservationSchema.parse(invalidData)).toThrowError('Only uppercase letters, numbers and spaces are allowed');
    });
  });
  ...
  describe('FeedbackSchema', () => {
    ...
    test('should throw error if message is too short', () => {
      ...
      expect(() => FeedbackSchema.parse(invalidData)).toThrowError('String must contain at least 10 character(s)');
    });
  });
  ...
  describe('ResetPasswordSchema', () => {
    ...
    test('should throw error if passwords do not match', () => {
      ...
      expect(() => ResetPasswordSchema.parse(invalidData)).toThrowError("Passwords don't match");
    });
    ...
    test('should throw error if password is too short', () => {
      ...
      expect(() => ResetPasswordSchema.parse(invalidData)).toThrowError('Password must be at least 8 characters long');
    });
  });
});
