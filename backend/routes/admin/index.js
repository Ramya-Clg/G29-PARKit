...
adminRouter.get("/dashboard", authorizationMiddleware, isAdmin, async (req, res) => {
    try {
...
adminRouter.get("/reservations", authorizationMiddleware, isAdmin, async (req, res) => {
    try {
...
adminRouter.get("/slots/stats", authorizationMiddleware, isAdmin, async (req, res) => {
    try {
...
// Get admin profile
adminRouter.get("/profile", authorizationMiddleware, isAdmin, async (req, res) => {
    try {
